...
const Integration = () => (
    ...
    >
        ...
        >
            NN cycle foundation has worked with the following
        </h2>
...
const Usp = () => (
    ...
    <section className={clsx(seCss.section, seCss["section--odd"])}>
        ...
        <p className={clsx(
            ...
            "text--center",
        )}> NN cycle foundation is a  section 8 non profit company working in the space of Active Mobility - Enablement and Empowerment by Active Mobility Innovation. We have pioneered many movements in the space of Active Mobility and Sustainability.
        </p>
...
const Cards = () => (
    <section className={clsx(seCss.section, seCss["section--odd"])}>
        <div className={clsx(seCss["section--inner"], seCss["section--center"])}>
            ...
            >
                Namma Nimma Cycle Foundation Purpose
            </h3>
            <p className={feCss.feature__content}>
                Our purpose is to reimagine active mobility  to improve people's lives.
                We use innovative science and technology to address some of society's
                most challenging mobility issues.
                We discover and develop breakthrough innovations and
                find new ways to deliver them to as many people as possible.
            </p>
            <div
                className={clsx(
                    seCss.section__footer,
...
const Home = () => (
    <Layout
        ...
        title="NN Cycle Foundation | Change the Future of Mobility"
        replaceTitle
    >
        <DemoCarousel />
