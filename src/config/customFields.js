...
module.exports = {
    ...
    copyright: `Copyright © ${new Date().getFullYear()} NN Cycle Foundation `,
    ...
    githubUrl: `${consts.githubOrgUrl}/nammacycle`,
    helmVersion: "0.11.0",
    linkedInUrl: "https://www.linkedin.com/company/lead-ride/",
    oneLiner: "Lead Ride: cycling together",
